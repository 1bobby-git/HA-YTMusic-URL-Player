...
REPOSITORY = "HA-YTMusic-URL-Player"
ARCHITECTURE_TEXT = "Architecture independent"
ARCHITECTURE_BADGE = "independent"
ARCHITECTURE_LINK = "https://github.com/1bobby-git/HA-YTMusic-URL-Player/blob/main/custom_components/ytmusic_url_player/manifest.json"
